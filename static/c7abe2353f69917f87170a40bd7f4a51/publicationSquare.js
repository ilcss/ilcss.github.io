...
class PublicationSquare extends Component {
  ...
  render() {
    const publicationLink = this.props.node.fileName
      ? this.props.node.fileName
      : this.props.node.linkName

    return (
      <div style={squareWrapperStyle}>
        <a href={publicationLink} target="_blank" style={aLinkStyle}>
          <div
          ...
          >
            <div style={publicationImageContainer}>
              <PublicationImage
                fileName={this.props.node.imageName}
                alt={this.props.node.title}
                style={publicationImageStyle}
              />
            </div>
            <div style={publicationText}>
              ...
              <p style={summaryStyle}>{this.props.node.summary}</p>

              <div style={detailsBox}>
                <p style={authorsStyle}>{this.props.node.authors}</p>
                <p style={journalStyle}>
                  <b>
                    {this.props.node.status}
                    {this.props.node.journal}{" "}
                  </b>
                  | {Moment(this.props.node.date).format("DD MMM YYYY")}
                </p>
              </div>
            </div>
          </div>
