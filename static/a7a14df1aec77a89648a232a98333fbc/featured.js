...
function LoadContent() {
  ...
  const featuredPublishedEdges = edges.filter(edge => {
    return edge.node.featured === true && edge.node.status === "Published in "
  })
  ...
  const newEdges = featuredPublishedEdges
    .concat(featuredEdges)
    .concat(nonFeaturedEdges)
